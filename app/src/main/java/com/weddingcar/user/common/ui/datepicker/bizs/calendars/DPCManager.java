package com.weddingcar.user.common.ui.datepicker.bizs.calendars;
...
public final class DPCManager {
    ...
    public DPInfo[][] obtainDPInfo(int year, int month) {
        HashMap<Integer, DPInfo[][]> dataOfYear = new HashMap<>();
...
//            System.out.println("obtainDPInfo-----2");
//            DPInfo[][] dataOfMonth = dataOfYear.get(month);
//            if (dataOfMonth != null) {
//                System.out.println("obtainDPInfo-----3");
//                return dataOfMonth;
//            }
//            dataOfMonth = buildDPInfo(year, month);
//            dataOfYear.put(month, dataOfMonth);
//            System.out.println("obtainDPInfo-----4");
//            return dataOfMonth;
//        }
...
//            for (int j = 0; j < dataOfMonth[i].length; j++) {
//                System.out.println("TEST=====>"+dataOfMonth[i][j]);
//            }
//        }
//        return dataOfMonth;
    }
