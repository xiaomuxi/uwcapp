...
import com.weddingcar.user.common.ui.datepicker.bizs.languages.DPLManager;
...
import com.weddingcar.user.common.ui.datepicker.utils.MeasureUtil;
...
//        rlTitle.addView(tvEnsure, lpEnsure);
    ...
    public void setOnDateClickListener(OnDateClickListener onDateClickListener) {
        monthView.setOnDateClickListener(new MonthView.OnDateClickListener() {
            @Override
            public void onClick(String dateStr) {
                onDateClickListener.onClick(dateStr);
            }
        });
    }

    public void setScrollEnable(boolean enable) {
        monthView.setScrollEnable(enable);
    }


    public void setSelectedDateList(List<String> dateList) {
        monthView.setSelectedDate(dateList);
    }
    ...
    List<String> getSelectedDateList() {
