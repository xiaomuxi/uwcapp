...
import com.weddingcar.user.common.map.GeoCoderUtil;
import com.weddingcar.user.common.map.LatLngEntity;
...
import com.weddingcar.user.function.wallet.adapter.PoiListAdapter;
...
public class AddressChooseActivity extends BaseActivity implements View.OnClickListener, Inputtips.InputtipsListener, AdapterView.OnItemClickListener
    ...
    protected void initActionBar() {
        ...
        setTopTitleAndLeftAndRight("选择地址");
        setTopRightText("确定");
    }
