...
public class CompleteCarListAdapter extends MyBaseAdapter<OrderCarListEntity.Data.ModelBean>{

    public CompleteCarListAdapter(Context c) {
        super(c);
    }

    @Override
    protected int setLayoutRes() {
        return R.layout.item_complete_car_list;
    }
    ...
    protected View getView(int position, View convertView, ViewGroup parent, ViewHolder holder) {
        ...
        TextView tv_sign_in = (TextView) convertView.findViewById(R.id.tv_sign_in);
        ...
        tv_sign_in.setText(StringUtils.equals("N", item.getQdState()) ? "未签到" : "已签到");
        iv_call.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                callPhone(item.getDriverID());
            }
        });
