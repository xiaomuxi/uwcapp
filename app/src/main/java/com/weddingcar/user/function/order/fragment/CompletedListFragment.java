...
import com.weddingcar.user.function.order.activity.CompleteOrderInfoActivity;
import com.weddingcar.user.function.order.adapter.CompleteListAdapter;
...
public class CompletedListFragment extends BaseLoadingFragment implements LoadMoreListView.OnRefreshListener{
    ...
    protected View setContentView() {
        return UIUtils.inflate(mContext, R.layout.fragment_complete_list);
    }
    ...
    protected void initCreated(Bundle savedInstanceState) {
        ...
        adapter = new CompleteListAdapter(mContext);
        list_view.setAdapter(adapter);
        list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(mContext, CompleteOrderInfoActivity.class);
