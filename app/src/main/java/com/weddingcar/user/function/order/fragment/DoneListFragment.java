...
import com.weddingcar.user.function.order.activity.DoneOrderInfoActivity;
import com.weddingcar.user.function.order.adapter.DoneListAdapter;
...
public class DoneListFragment extends BaseLoadingFragment implements LoadMoreListView.OnRefreshListener{
    ...
    protected View setContentView() {
        return UIUtils.inflate(mContext, R.layout.fragment_done_list);
    }
    ...
    protected void initCreated(Bundle savedInstanceState) {
        ...
        adapter = new DoneListAdapter(mContext);
        list_view.setAdapter(adapter);
        list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(mContext, DoneOrderInfoActivity.class);
